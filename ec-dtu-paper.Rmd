...
test_reduced <- test[,grep('gene|featurecounts_flat|kallisto|miso', colnames(test))]
...
cols <- c('salmon' = '#4daf4a',
          'equivalence_class' = '#377eb8',
          'dexseq_count_exons' = '#e41a1c',
          'kallisto' = '#984ea3',
          'featurecounts_flat' = '#ff7f00',
          'miso_assignable' = '#ffd92f')
...
```{r SupplementaryFigure6, fig.width=12, fig.height=5.25}
group <- rep(c('c1','c2'), each=3)
...
cols <- c('salmon' = '#fdae6b',
          'salmon_filt' = '#e6550d',
          'equivalence_class' = '#9ecae1',
          'equivalence_class_filt' = '#3182bd',
          'dexseq_count_exons' = '#a1d99b',
          'dexseq_count_exons_filt' = '#31a354')
...
```{r SupplementaryFigure7, fig.width=12, fig.height=5.25}
